...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowIcon(QIcon(str(resource("vita-pulse.svg"))))
    ...
    def _build(self):
        ...
        top.setSpacing(15)
        logo = QLabel()
        logo.setPixmap(QIcon(str(resource("vita-pulse.svg"))).pixmap(QSize(54, 54)))
        top.addWidget(logo)
        brand = QVBoxLayout()
        brand.setSpacing(0)
    ...
    def refresh_detail(self):
        ...
        if icon.isNull():
            icon = QIcon(str(resource("vita-pulse.svg"))).pixmap(QSize(72, 72))
